...
<body> <body background="123.jpg"></body>
  <div class="div1">
    <div class="div2_1">
        <div class="div3_2">
             <span>在线考试系统</span>
    ...
    <div class="div2_2">
     <center>
    	...
    	<form id="form1" action="${pageContext.request.contextPath }/admin_login.action" method="post" onsubmit="return checkForm()" >
        	<table border="0px">
            	<tr>
                	<td style="text-align:center" colspan="3"><strong style="font-size:20px">管理员登录</strong></td>  
                </tr>
                <tr>
                	<td style="text-align:right;">管理员帐号：</td>
                ...
                <tr>
                 ...
                 <tr>	
                    <td colspan="3">
                    	<input style="width:100px; height:30px" type="submit" style="border-radius: 8px" value="登录"/>
                        <input style="width:100px; height:30px" type="reset" style="border-radius: 8px" value="重置"/>
                    </td>
                </tr>
            </table>  
        </form>
