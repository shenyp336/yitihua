  ...
  <head>
	...
	<script type="text/javascript">
		...
		function checkId(){
			...
			var flag ;
			if(tid == ""){
				idspan.innerHTML = "* 教师编号不能为空".fontcolor("red").fontsize("2px");
				flag = false;
			}else if(!reg.test(tid)){
				idspan.innerHTML = "* 教师编号只能是数字".fontcolor("red").fontsize("2px");
				flag = false;
			}else{
				idspan.innerHTML = "";
				flag = true;
  ...
  <div class="div1">
    ...
    <div class="div2_2">
     <center>
    	...
    	<form id="form1" action="${pageContext.request.contextPath }/teacher_login.action" method="post" onsubmit="return checkForm()" >
        	<table border="0px">
            	<tr>
                	<td style="text-align:center" colspan="3"><strong style="font-size:20px">教师登录</strong></td>  
                </tr>
                <tr>
                	<td style="text-align:right;">教师帐号：</td>
                    <td style="text-align:left;">
                    	<input id="tid" type="text" style="width:160px;" name="tid" onblur="checkId()" />
                    </td>
