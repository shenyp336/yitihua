...
<html>
  ...
  <body>
    ...
    <div id="div1">
    	<div id="div2">
    		<form id="form1" action="${pageContext.request.contextPath }/question_ckXSTKAdminQuestion.action?qtid=3" method="post" target="mainFrame" onsubmit="return checkForm()">
    			<table>
    				<tr>
