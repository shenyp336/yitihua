...
<html>
  ...
  <body>
  	...
  	<div id="div1">
   		<form id="form1" action="${pageContext.request.contextPath }/admin_updatePW.action?uid=<s:property value="#session.existAdmin.uid"/>" method="post" target="mainFrame" onsubmit="return checkForm('<s:property value="#session.existAdmin.password" />')">
   			<table>
   				<tr>
