...
<html>
  ...
  <body>
  	...
  	<div id="div1">
   		<form id="form1" action="${pageContext.request.contextPath }/questionPaper_tjAdminQuestionPaper.action" method="post" target="mainFrame" onsubmit="return checkForm('<s:property value="#session.existTeacher.password" />')">
   			<table>
   				<tr>
