...
<html>
  ...
  <body>
    ...
    <div class="divtitle2">
    	<form action="${pageContext.request.contextPath }/question_addAdminQuestionPDSX.action?qtid=2" target="mainFrame" method="post">
    		...
    		<input type="submit" value="确定添加试题"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/question_addAdminQuestionPD.action">重新添加试题</a>
    	</form>
