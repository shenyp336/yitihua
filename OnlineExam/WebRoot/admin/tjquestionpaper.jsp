...
<html>
  ...
  <body>
    ...
    <div class="divtitle2">
    	<form action="${pageContext.request.contextPath }/questionPaper_tjAdminQuestion.action?qpid=<s:property value="questionPaper.qpid"/>&page=1" target="mainFrame" method="post" onsubmit="return checkForm()">
